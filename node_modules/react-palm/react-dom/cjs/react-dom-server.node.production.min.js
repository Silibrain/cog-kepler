...
function va(a, b) {
  function d(c, g) {
    ...
    ua(a, g);
    c = void 0;
    if ('function' === typeof e.getChildContext && (d = g.childContextTypes, 'object' === (typeof d === 'undefined' ? 'undefined' : _typeof(d)))) {
      c = e.getChildContext();
      for (var w in c) {
...
var Y = function () {
  ...
  a.prototype.render = function (a, d, c) {
    ...
    if ('object' === (typeof b === 'undefined' ? 'undefined' : _typeof(b)) && null !== b) switch (b.$$typeof) {
      case H:
    ...
    t('130', null == b ? b : typeof b === 'undefined' ? 'undefined' : _typeof(b), '');
  };
  a.prototype.renderDOM = function (a, d, c) {
    ...
    if ('input' === b) f = p({ type: void 0 }, f, {
      ...
      if (null != l) {
        ...
        f = p({ selected: void 0, children: void 0 }, f, {
          selected: k,
          children: D
        });
      }
...
function wa(a, b) {
  if ('function' !== typeof b && null !== b) throw new TypeError('Super expression must either be null or a function, not ' + (typeof b === 'undefined' ? 'undefined' : _typeof(b)));
...
var xa = function (a) {
  function b(d, c) {
    ...
    g = !g || 'object' !== (typeof g === 'undefined' ? 'undefined' : _typeof(g)) && 'function' !== typeof g ? this : g;
